...
function displayResults(data) {
  ...
  for(var i = 0; i < data.length; i++){
    $("tbody").append("<tr><td>"+ data[i].name +"</td><td>"+data[i].numlegs+
    "</td><td>"+ data[i].class +"</td><td>"+ data[i].weight+
    "</td><td>"+ data[i].whatWouldIReallyCallIt +"</td></tr>");
  }
}
