...
class Panel extends Component {
  ...
  renderPage(){
    if(this.state.selected.value === "SHOW_LOREM"){
        return(
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et dapibus justo, non tincidunt lacus. Morbi sit amet porttitor massa, id pulvinar est. Quisque pret</p>
        )
    }
    else if (this.state.selected.value === "SHOW_CAT") {
        return(
          <img src="https://i.ytimg.com/vi/iRXJXaLV0n4/hqdefault.jpg"></img>
        )
    }
